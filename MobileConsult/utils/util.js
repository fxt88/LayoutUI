...
function post(params) {
  ...
  var jointRequestBody = function (token, data, timestamp) {
    var header = {
      Token: token,
      StatusCode: 0,
      Message: null,
  ...
  var requestBody = jointRequestBody(token(data.isToken), data, timestamp);//不需Token验证isToken设置为True
